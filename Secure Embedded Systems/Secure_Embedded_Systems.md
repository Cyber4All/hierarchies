Overview Secure Embedded Systems Hierarchy Structure
```
Secure Embedded Systems Learning Object (Unit)
...
|     |─── Lab2_ServerCommunication_DataFiles (Folder)
|     |     └── Graph.py.txt
|     |     └── Lab1.py.txt
|     |     └── temp-script.py.txt
|
...
|     |─── Lab3_RandomNummberGeneration_DataFiles (Folder)
|     |     └── badRandonNo.ipynb
|     |     └── nizam.png
|     |     └── random_nos_2_corrected.ipynb
|     |     |─── .ipynb_checkpoints (Folder)
|     |          └── badRandonNo-checkpoint.ipynb
|     |          └── random_nos_2_corrected-checkpoint.ipynb
|     |     |───  .ipython (Folder)
|     |          |─── profile_default (Folder)
|     |               └── history.sqlite
|     |               |─── profile_default (Folder)
|     |                    └── README
|     |     |─── .matplotlib (Folder)
...
|     |─── Lab4_DictionaryAttack_Datafiles (Folder)
|     |     └── dictionaryssh.py
|     |     └── password_list.txt
|   
...
|     |─── Lab5_DictionaryAttack-Fail2Ban_Datafiles (Folder)
|     |     └── dictionaryssh.py
|     |     └── password_list.txt
|   
